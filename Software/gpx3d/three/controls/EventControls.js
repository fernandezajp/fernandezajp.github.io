...
EventsControls = function ( camera, domElement ) {
	...
	this._raySet = function () {
		...
		if ( _this.camera instanceof THREE.OrthographicCamera || (_this.camera instanceof THREE.CombinedCamera && _this.camera.inOrthographicMode)) {
