...
this.viewTop = function() {
	rotateUp(spherical.phi);
	rotateLeft(spherical.theta);
	scope.update();
}

this.viewBottom = function() {
	//angle = - Math.PI;
	rotateUp(spherical.phi-Math.PI);
	rotateLeft(spherical.theta);
	scope.update();
}
...
this.viewFront = function() {
	//angle = - Math.PI / 2;
	rotateUp(spherical.phi-Math.PI/2);
	rotateLeft(spherical.theta);
	scope.update();
}
...
this.viewLeft = function() {
	rotateUp(spherical.phi-Math.PI/2);
	rotateLeft(spherical.theta-Math.PI/2);
	scope.update();
}
...
this.viewBack = function() {
	rotateUp(spherical.phi-Math.PI/2);
	rotateLeft(spherical.theta+Math.PI);
	scope.update();
}
